...
<%--
		<c:set var="enrichment_category_who_t_extra"   value="<li>test who</li>"/>
		<c:set var="enrichment_category_what_t_extra"  value="<li>test what</li>"/>
		<c:set var="enrichment_category_where_t_extra" value="<li>test where</li>"/>
		<c:set var="enrichment_category_when_t_extra"  value="<li>test when</li>"/>
 --%>
					...
					<c:choose>
						<c:when test="${model.showContext && !empty value.decorator}">
							...
							<c:set var="extramarkup">
								<!-- copied from displayEseDataAsHtml -->
								...
								<!-- end copied from displayEseDataAsHtml -->
							</c:set>
