	...
	<div class="eu-menu no-highlight white" id="lang-menu">
		...
		<ul title="<spring:message code="ChooseLanguage_t" />">
			<li class="item icon-home show-on-phones">
				<a class="treat-as-link" target="<spring:message code="notranslate_main_menu_home_a_target_t" />" href="/"><spring:message code="main_menu_home_a_text_t" /></a>
			</li>

			<li class="item icon-logo show-on-phones">
				<a class="treat-as-link" target="<spring:message code="notranslate_main_menu_myeuropeana_a_target_t" />" href="/${model.myEuropeanaUrl}"><spring:message code="main_menu_myeuropeana_a_text_t" /></a>
			</li>

			<li class="item icon-info show-on-phones">
				<a class="treat-as-link" href="/usingeuropeana.html"><spring:message code="rswHelp_t" /></a>
			</li>
