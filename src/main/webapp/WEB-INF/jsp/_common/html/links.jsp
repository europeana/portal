...
<c:choose>
	<c:when test="${!empty model.minify && model.minify == TRUE}">
		<%@ include file="/WEB-INF/jsp/_common/html/css/production-css.jsp" %>
	</c:when>
	<c:otherwise>
		<%@ include file="/WEB-INF/jsp/_common/html/css/debug-css.jsp" %>
	</c:otherwise>
</c:choose>
