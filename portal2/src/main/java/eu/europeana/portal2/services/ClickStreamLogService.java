...
public interface ClickStreamLogService {
	...
	public enum UserAction {
		...
		BRIEF_RESULT, BRIEF_RESULT_FROM_PACTA, BRIEF_RESULT_FROM_SAVED_SEARCH, 
		BRIEF_RESULT_FROM_OPEN_SEARCH, FULL_RESULT_HMTL, FULL_RESULT_JSON, 
		FULL_RESULT_SRW, FULL_RESULT_EMBEDED, FULL_RESULT_FROM_SAVED_ITEM, 
		FULL_RESULT_FROM_SAVED_TAG, FULL_RESULT_FROM_YEAR_GRID, FULL_RESULT_FROM_TIME_LINE_VIEW, 
		MORE_LIKE_THIS, RETURN_TO_RESULTS, REDIRECT_OUTLINK, REDIRECT_TO_SECURE, 
		TIMELINE, MAPVIEW, WIKIPEDIA, TAG_GRID, YEAR_GRID, BROWSE_BOB, 
		BROWSE_ALL, SITE_MAP_XML,

		SHOW_SIWA_MENU,

		// ajax related actions
		SAVE_ITEM, SAVE_SEARCH, SAVE_SOCIAL_TAG, SAVE_SEARCH_TERM, 
		SAVE_NOTIFICATION_EMBED, REMOVE_SAVED_ITEM, REMOVE_SAVED_SEARCH,
		REMOVE_SOCIAL_TAG, REMOVE_SEARCH_TERM, SEND_EMAIL_TO_FRIEND, 
		TAG_AUTOCOMPLETE,
		...
		MY_EUROPEANA, UNREGISTER, CHANGE_PASSWORD_SUCCES, CHANGE_PASSWORD_FAILURE,
		LOGIN, LOGOUT, LOGOUT_COOKIE_THEFT,
