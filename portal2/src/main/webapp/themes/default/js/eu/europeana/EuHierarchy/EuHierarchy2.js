var EuHierarchy = function(cmp, rows, wrapper) {
    ...
    var addTransitionClasses = function(){
    ...
    var formatNodeData = function(ob, wrapInfo){
        ...
        if(ob.action === "self.json"){
            ...
            newOb = {
                    ...
                    "text" : normaliseText(ob.self.id, ob.self.title, ob.self.type, ob.self.childrenCount, ob.self.index, ob.self.parent, ob.self.relBefore),
                    "data" : {
            ...
            newOb = {
                    "id" : escapeId(ob.id),
                    "text" : normaliseText(ob.id, ob.title, ob.type, ob.childrenCount, ob.index, parent, ob.relBefore),
                    "data" : {
        ...
        while(xNode.parent){
            ...
            if( xNode.id != '#'){
                ...
                if($('#' + xNode.id + ' > .jstree-children').length || $('#' + xNode.id).hasClass('jstree-last')  ){
                    ...
                    topArrows.append('<div title="' + unordered + '" class="' + createClass + '" style="right:' + rightIndent + 'em">');
