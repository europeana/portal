<div id="actions" class="sidebar notranslate">
  <div id="additional-actions">
    <%@ include file="/WEB-INF/jsp/devel/fulldoc/content/sidebar-right/translate-item.jspf" %>
    <%@ include file="/WEB-INF/jsp/devel/fulldoc/content/sidebar-right/item-save.jspf" %>
    <%@ include file="/WEB-INF/jsp/devel/fulldoc/content/sidebar-right/embed.jspf" %>
