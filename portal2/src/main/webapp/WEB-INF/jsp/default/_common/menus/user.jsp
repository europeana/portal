<if model.user??>
	...
	| <spring:message code="SavedItems_t" />:
		<a href="/{model.portalName}/myeuropeana#saved-items">{model.user.savedItems?size}</a>
	</if>
	<if model.user.savedSearches?exists>
	| <spring:message code="SavedSearches_t" />:
	<a href="/{model.portalName}/myeuropeana#saved-searches">{model.user.savedSearches?size}</a>
	</if>
	<if model.user.socialTags?exists>
	| <spring:message code="SavedTags_t" />:
	<a href="/{model.portalName}/myeuropeana#saved-tags">{model.user.socialTags?size}</a>
	</if>
