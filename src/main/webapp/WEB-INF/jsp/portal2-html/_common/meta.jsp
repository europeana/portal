<meta name="description" content="${model.pageTitle}"/><c:if test="${not model.indexable}">
<c:choose>
...
<%@ include file="/WEB-INF/jsp/vanilla/_common/meta-facebook.jsp" %>
<%@ include file="/WEB-INF/jsp/vanilla/_common/meta-open-graph.jsp" %>
