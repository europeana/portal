...
<%@ include file="/WEB-INF/jsp/vanilla/_common/menus/main.jsp" %>
<%-- <%@ include file="/WEB-INF/jsp/vanilla/_common/menus/user.jsp" %> --%>
<%@ include file="/WEB-INF/jsp/vanilla/_common/query/query.jsp" %>