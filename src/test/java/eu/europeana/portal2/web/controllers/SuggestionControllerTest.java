...
public class SuggestionControllerTest {
	...
	private String[] topWords() {
		return new String[]{"http", "th", "centuri", "го", "of", "www", "eu", "right", "europeana", "rr", "the", "de", "20", "f", 
			...
			"print", "national", "bibliothequ", "materi", "fre", "art", "espana", "sa", "18", "inform", "nr", "numero", "standort", 
			...
			"census", "duiskka", "alemanyi", "eireann", "heireann", "19110402", "cartlann", "naisiunta", "departement", "el", "with", "m", 
			"bildarchiv", "architektura", "architettura", "het", "sn", "05", "v", "arquitectura", "2005", "arkitektur", "cultur", 
			"architectuur", "arhitectura", "architektūra", "arhitektura", "architektura", "arhitektuur", "arkkitehtuuri", "fysisk", 
