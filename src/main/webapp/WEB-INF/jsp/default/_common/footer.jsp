					...
					<ul class="menu" role="navigation">
						...
						<li>
							...
							<ul>
								...
								<li><a href="<spring:message code="notranslate_main_menu_explore_4_a_url_t"/>" target="<spring:message code="notranslate_main_menu_explore_4_a_target_t"/>" title="<spring:message code="main_menu_explore_4_a_title_t"/>"><spring:message code="main_menu_explore_4_a_text_t"/></a></li>
								<li><a href="<spring:message code="notranslate_main_menu_explore_5_a_url_t"/>" target="<spring:message code="notranslate_main_menu_explore_5_a_target_t"/>" title="<spring:message code="main_menu_explore_5_a_title_t"/>"><spring:message code="main_menu_explore_5_a_text_t"/></a></li>
								<li><a href="<spring:message code="notranslate_main_menu_explore_6_a_url_t"/>" target="<spring:message code="notranslate_main_menu_explore_6_a_target_t"/>" title="<spring:message code="main_menu_explore_6_a_title_t"/>"><spring:message code="main_menu_explore_6_a_text_t"/></a></li>
							</ul>
						</li>
						<%-- Help --%>
						<li>
						...
						<li>
							...
							<ul>
								<li><a href="<spring:message code="notranslate_main_menu_follow_1_a_url_t"/>" target="<spring:message code="notranslate_main_menu_follow_1_a_target_t"/>" title="<spring:message code="main_menu_follow_1_a_title_t"/>"><spring:message code="main_menu_follow_1_a_text_t"/></a></li>
								<li><a href="<spring:message code="notranslate_main_menu_follow_2_a_url_t"/>" target="<spring:message code="notranslate_main_menu_follow_2_a_target_t"/>" title="<spring:message code="main_menu_follow_2_a_title_t"/>"><spring:message code="main_menu_follow_2_a_text_t"/></a></li>
								<li><a href="<spring:message code="notranslate_main_menu_follow_3_a_url_t"/>" target="<spring:message code="notranslate_main_menu_follow_3_a_target_t"/>" title="<spring:message code="main_menu_follow_3_a_title_t"/>"><spring:message code="main_menu_follow_3_a_text_t"/></a></li>
								<li><a href="<spring:message code="notranslate_main_menu_follow_4_a_url_t"/>" target="<spring:message code="notranslate_main_menu_follow_4_a_target_t"/>" title="<spring:message code="main_menu_follow_4_a_title_t"/>"><spring:message code="main_menu_follow_4_a_text_t"/></a></li>
							</ul>
						</li>
