				...
				<c:otherwise>
					<span class="white">
						...
						<c:if test="${!empty model.user.savedItems}">
							...
							<a	id="saved-items-count"
								href="/${model.portalName}/<spring:message code="notranslate_main_menu_myeuropeana_a_url_t"/>#saved-items">${fn:length(model.user.savedItems)}</a>
						...
						<c:if test="${!empty model.user.savedSearches}">
							...
							<a	id="saved-searches-count"
								href="/${model.portalName}/<spring:message code="notranslate_main_menu_myeuropeana_a_url_t"/>#saved-searches">${fn:length(model.user.savedSearches)}</a>
