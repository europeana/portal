...
<link rel="canonical" href="${model.document.edmLandingPage[0]}" vocab="http://schema.org/" typeof="CreativeWork"
 about="${aboutUrl}" property="url http://www.europeana.eu/schemas/edm/landingPage" />
