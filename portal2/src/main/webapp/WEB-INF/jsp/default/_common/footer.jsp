		...
		<div class="footer-wrapper">
			...
			<div class="row" id="footer-links-all">
				...
				<div class="four columns">
					...
					<h3>
						<a class="europeana" href="<spring:message code="notranslate_main_menu_aboutus_a_url_t"/>" target="<spring:message code="notranslate_main_menu_aboutus_a_target_t"/>" title="<spring:message code="main_menu_aboutus_a_title_t"/>"><spring:message code="main_menu_aboutus_a_text_t"/></a>
					</h3>
					<ul class="footer-links">
						<li><a class="europeana" href="<spring:message code="notranslate_main_menu_aboutus_1_a_url_t"/>" target="<spring:message code="notranslate_main_menu_aboutus_1_a_target_t"/>" title="<spring:message code="main_menu_aboutus_1_a_title_t"/>"><spring:message code="main_menu_aboutus_1_a_text_t"/></a></li>
						<li><a class="europeana" href="<spring:message code="notranslate_main_menu_aboutus_2_a_url_t"/>" target="<spring:message code="notranslate_main_menu_aboutus_2_a_target_t"/>" title="<spring:message code="main_menu_aboutus_2_a_title_t"/>"><spring:message code="main_menu_aboutus_2_a_text_t"/></a></li>
						<li><a class="europeana" href="<spring:message code="notranslate_main_menu_aboutus_3_a_url_t"/>" target="<spring:message code="notranslate_main_menu_aboutus_3_a_target_t"/>" title="<spring:message code="main_menu_aboutus_3_a_title_t"/>"><spring:message code="main_menu_aboutus_3_a_text_t"/></a></li>
...
<div class="row footer-bottom-links">
	<div class="twelve columns">
		...
		<a class="europeana footer-bottom-link" href="<spring:message code="footer_menu_tou_url_t"/>" target="<spring:message code="footer_menu_tou_target_t"/>" title="<spring:message code="footer_menu_tou_title_t"/>"><spring:message code="footer_menu_tou_text_t"/></a>
		<a class="europeana footer-bottom-link" href="<spring:message code="footer_menu_contact_us_url_t"/>" target="<spring:message code="footer_menu_contact_us_target_t"/>" title="<spring:message code="footer_menu_contact_us_title_t"/>"><spring:message code="footer_menu_contact_us_text_t"/></a>
		<a class="europeana footer-bottom-link" href="<spring:message code="footer_menu_sitemap_url_t"/>" target="<spring:message code="footer_menu_sitemap_target_t"/>" title="<spring:message code="footer_menu_sitemap_title_t"/>"><spring:message code="footer_menu_sitemap_text_t"/></a>
