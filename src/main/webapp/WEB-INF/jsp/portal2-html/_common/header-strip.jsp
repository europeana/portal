...
<%-- language options --%>
<li class="item lang"><spring:message code='ChooseLanguage_t' /></li><c:forEach items="${model.portalLanguages}" var="language">
<li class="item lang"><a class="${language.languageCode}">${language.languageName}</a></li></c:forEach>
</ul>
</div>
<%-- Choose a language --%>
<%@ include file="/WEB-INF/jsp/portal2-html/_common/language.jsp" %>
</div>
</div>