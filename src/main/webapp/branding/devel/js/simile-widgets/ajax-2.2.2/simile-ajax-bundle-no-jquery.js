...
SimileAjax.jQuery=jQuery.noConflict();
...
/* modified dan entous if(!SimileAjax.Graphics.pngIsTranslucent){SimileAjax.includeCssFile(document,SimileAjax.urlPrefix+"styles/graphics-ie6.css");
