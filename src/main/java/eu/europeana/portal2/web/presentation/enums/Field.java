...
public enum Field {
	...
	EUROPEANA_COUNTRY("europeana:country", null, new Wordcapitalizer()),
	EUROPEANA_PROVIDER("europeana:provider", "Provider_t", "europeana_provider:\"%s\" OR europeana_country:\"%s\"", false, false, false, 
		ExternalService.WIKIPEDIA, ExternalService.INTERNETARCHIVE, ExternalService.SMITHSONIAN,
		ExternalService.GOOGLE, ExternalService.GOOGLEMAPS, ExternalService.YOUTUBE,
		ExternalService.IMDB, ExternalService.FLICKR, ExternalService.GOOGLEBOOKS,
		ExternalService.WORLDCAT),	
	EUROPEANA_COLLECTIONNAME("europeana:collectionName", null, "europeana_collectionName:%s"),
	EUROPEANA_ISSHOWNAT("europeana:isShownAt", null),
	EUROPEANA_ISSHOWNBY("europeana:isShownBy", null),
	EUROPEANA_OBJECT("europeana:object", null),
	EUROPEANA_LANGUAGE("europeana:language", null),
	EUROPEANA_TYPE("europeana:type", null),
	EUROPEANA_USERTAG("europeana:userTag", null),
	EUROPEANA_YEAR("europeana:year", null),
	EUROPEANA_RIGHTS("europeana:rights", "europeana_rights_t", false, false, false, ExternalService.none()),
	EUROPEANA_DATAPROVIDER("europeana:dataProvider", "europeana_dataProvider_t", "europeana_dataProvider:\"%s\"", false, false, false,
