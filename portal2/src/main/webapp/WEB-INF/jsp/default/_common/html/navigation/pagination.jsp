      ...
      <ul class="result-pagination">
        ...
        <li class="nav-numbers">
          ...
          <form method="get" action="${query_action}?" class="jump-to-page">
            ...
            <input type="text" id="start-page" value="${model.pageNumber}"  disabled="disabled" style="border:none; color:black; background-color:white; text-align:right;"/>
        ...
        <li class="nav-last">
          <c:if test="${!model.briefBeanView.pagination.last || isSearchWidget}">
            <a href="${homeUrl}${model.lastPageUrl}" title="<spring:message code="AltLastPage_t"/>" style="display:none;">&nbsp; &gt;&gt;</a>
          </c:if>
        </li>
      </ul>
    </div>
