...
<%-- optional --%><meta property="og:description" content="${model.pageTitle}"/>
<meta property="og:site_name" content="Europeana"/><%--<meta property="og:locale" content="%{model.locale}"/>--%>